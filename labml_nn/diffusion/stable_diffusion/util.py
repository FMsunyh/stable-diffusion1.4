...
def load_model(path: Path = None) -> LatentDiffusion:
    ...
    with monit.section('Initialize CLIP Embedder'):
        clip_text_embedder = CLIPTextEmbedder(version="/root/kohya-ss/dataset/.cache/huggingface/hub/models--openai--clip-vit-large-patch14/snapshots/8d052a0f05efbaefbc9e8786ba291cfdf93e5bff",device="cuda:1")
